...
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Weight,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:weight,:status)";
